            ...
            <div class="container pt-14 container pt-14 pt-md-14">
               ...
               <div class="tab-content">
                  <div class="tab-pane fade show active" id="all">
                     ...
                     @foreach ($eventAll as $event)
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-6">
                           <div class="card">
                           <figure class="card-img-top overlay overlay1 hover-scale"><a href="{{url('/event/'.$event->id.'/detail')}}"><span class="bg"></span> <img src="{{Storage::url($event->image)}}" alt=""></a>
                           <figcaption>
                           ...
                           <div class="post-header">
                              ...
                              <!-- /.post-category -->
                              <h2 class="post-title h3 mt-1 mb-3"><a class="link-dark" href="{{url('/event/'.$event->id.'/detail')}}">{{$event->name}}</a></h2>
                  ...
                  <div class="tab-pane fade" id="food">
                     <div class="row mt-10">
                     @foreach ($eventGastronomie as $event)
                        <div class="col-lg-4 col-md-4 col-sm-12 mb-6">
                           <div class="card">
                           <figure class="card-img-top overlay overlay1 hover-scale"><a href="{{url('/event/'.$event->id.'/detail')}}"><span class="bg"></span> <img src="{{Storage::url($event->image)}}" alt=""></a>
                           <figcaption>
